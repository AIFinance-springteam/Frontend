  ...
  return (
    <section className="rounded-2xl border border-neutral-200 bg-white p-5 text-left shadow-sm">
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-lg py-1.5 text-[13px] active:bg-neutral-50"
      >
        <span className="text-[13px] font-normal">부담자 미지정</span>
        <span className="text-[13px] font-medium text-neutral-500">{unassignedCount}건 ›</span>
      </button>
